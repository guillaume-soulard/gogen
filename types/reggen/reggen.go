...
func NewGenerator(regex string, rand *rand.Rand) (*Generator, error) {
...
func Generate(regex string, rand *rand.Rand, limit int) (string, error) {
	g, err := NewGenerator(regex, rand)
	if err != nil {
		return "", err
	}
